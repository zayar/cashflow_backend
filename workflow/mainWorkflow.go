...
// Update balances for current stock history and the following histories
func UpdateStockClosingBalances(tx *gorm.DB, newStockHistories []*models.StockHistory, lastStockHistories []*models.StockHistory) error {
